...
package fast.wq.com.fastandroid.view.recyclerview.adapter;
...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public T getItem2(int position) {
        int truePos = position - getHeaderViewsCount();
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int positions) {
        ...
        switch (viewType) {
            case 0:
                ...
                viewHolder.setItemPosition(positions);
                convert(viewHolder, mData.get(holder.getLayoutPosition() - getHeaderLayoutCount()));
                //addAnimation(holder);
                break;
            case LOADING_VIEW:
                addLoadMore(holder);
            ...
            default:
                ...
                baseViewHolder.setItemPosition(positions);
                convert(baseViewHolder, mData.get(holder.getLayoutPosition() - getHeaderLayoutCount()));
                break;
        }
    }
